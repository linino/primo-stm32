...
#define DAPLINK_ROM_CONFIG_ADMIN_START  0x0800EC00
#define DAPLINK_ROM_CONFIG_ADMIN_SIZE   0x00000100

#define DAPLINK_ROM_IF_START            0x08000000
#define DAPLINK_ROM_IF_SIZE             0x0000EC00

#define DAPLINK_ROM_CONFIG_USER_START   0x0800F000
#define DAPLINK_ROM_CONFIG_USER_SIZE    0x00001000

#else

#define DAPLINK_ROM_BL_START            0x08000000
#define DAPLINK_ROM_BL_SIZE             0x00002C00

#define DAPLINK_ROM_CONFIG_ADMIN_START  0x0800EC00
#define DAPLINK_ROM_CONFIG_ADMIN_SIZE   0x00000100

#define DAPLINK_ROM_IF_START            0x08003C00
#define DAPLINK_ROM_IF_SIZE             0x0000B000
